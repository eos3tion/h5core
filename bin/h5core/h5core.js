...
(function (junyou) {
    ...
    (function (TouchDown) {
        ...
        function touchBegin(e) {
            ...
            data.tween = junyou.Global.getTween(target, _$TDOpt).to({ x: x - width * 0.0625 /* Multi */, y: y - height * 0.0625 /* Multi */, scaleX: 1.125 /* Scale */ * scaleX, scaleY: 1.125 /* Scale */ * scaleY }, 100, junyou.Ease.quadOut);
        }
        function touchEnd(e) {
            var target = e.target;
