...
declare namespace jy {
    ...
    class UnitAction {
         ...
         * 播放动作
         */
        start(unit: Unit, now: number): boolean;
        /**
         * 动作执行数据计算<br/>
         * 如更新单位坐标等
         */
