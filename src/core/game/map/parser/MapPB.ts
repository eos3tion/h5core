namespace jy {
    ...
    export const MapPB: PBStructDictInput = {
        //↓↓↓↓↓ [文本框中，复制粘贴] ↓↓↓↓↓
        /*GridMapInfoPB*/100: { 1: ["columns", 2, 5], 2: ["rows", 2, 5], 3: ["gridWidth", 2, 5], 4: ["gridHeight", 2, 5], 5: ["pathdata", 1, 12], 6: ["alphadata", 1, 12], 7: ["pdatabit", 1, 5], 8: ["points", 1, 11, MapPBDictKey.PointGroupPB] },
